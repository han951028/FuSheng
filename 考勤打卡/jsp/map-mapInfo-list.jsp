...
$(function(){
	$("#buttonId").click(function(){
		...
		$("#forms").attr("action", "map-mapInfo-list.do");
		$("#forms").submit();
	})
	$("#buttonExport").click(function(){
		...
		$("#forms").attr("action", "map-mapInfo-export.do");
		$("#forms").submit();
	})
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  	...
		  	<form id="forms" name="domap-userInfo" method="post"  class="form-inline">
		   ...
		   <!-- <label for="domap-domapInfo-groupName"><spring:message code='domap-domapInfo.domap-domapInfo-groupName' text='考勤组'/>:</label>
		    <tags:getcodeList selectName="filter_LIKES_groupName" selectId="domap-domapInfo-groupName" selectValue="${param.filter_LIKES_groupName}" selectCalss="form-control" code="cms"  ></tags:getcodeList>
		  		   &nbsp; -->	
		 <button id="buttonId" class="btn btn-primary " type="button" style="margin-bottom: 2px;margin-left:40px" >						
				<i class="fa-search">&nbsp;&nbsp;查&nbsp;询</i>
		 </button>
		 <button id="buttonExport" class="btn btn-primary"  type="button" style="margin-bottom: 2px">
				<i class="fa-arrow-circle-down">&nbsp;&nbsp;导&nbsp;出</i>
		</button>
		 </form>
  ...
  <table id="cmsArticleGrid" class="table table-striped table-hover table-bordered dataTable"> 
    <thead>
     ...
     <!--    <th width="10" class="table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th> -->
        ...
        <th class="sorting"  width="100px">状态</th>
        <th class="sorting"  width="120px">手机异常</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="map-mapInfo-input.do?id=${item.id}" >编辑</a>
